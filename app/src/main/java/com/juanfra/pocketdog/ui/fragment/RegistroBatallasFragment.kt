 ...
 * Use the [RegistroBatallasFragment.newInstance] factory method to
...
class RegistroBatallasFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment RegistroBatallasFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            RegistroBatallasFragment().apply {
